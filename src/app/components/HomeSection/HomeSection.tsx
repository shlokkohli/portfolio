    ...
    <div className=' flex items-center justify-center gap-29 w-full'>
      ...
      <div className='flex flex-col gap-8 max-w-2xl'>
        ...
        <div className='flex flex-col gap-6'>
          ...
          <div className='flex flex-col md:items-start items-center'>
            ...
            <h2 className='font-bold text-sm sm:text-lg text-emerald-600'>
              <TypeAnimate />
            </h2>
          </div>
        ...
        <div className='flex flex-col md:flex-row gap-3 md:gap-5 lg:gap-7'>
          ...
          <button className='bg-gradient-to-r from-blue-500 to-cyan-500 flex justify-center items-center p-2.5 rounded-full text-sm sm:font-semibold font-semibold gap-2 cursor-pointer px-4 sm:px-5 md:px-7 w-full md:w-auto hover:from-blue-600 hover:to-cyan-600  hover:scale-105 transition-all duration-200'>
            Get in Touch
      ...
      <div className='hidden md:block'>
        ...
        <div className='bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 rounded-full md:h-55 md:w-55 lg:h-60 lg:w-60 flex items-center justify-center overflow-hidden transition-all duration-500'>
          <img className='md:h-50 md:w-42 lg:h-55 lg:w-46' src="profileImage.png" alt="ProfilePhoto" />
        </div>
